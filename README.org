...
- Instead of using such solution, this project will use heuristic based approach(vs knowledge base approach) for for the computer player.
...
- Current tentative milestones[2/9]:
